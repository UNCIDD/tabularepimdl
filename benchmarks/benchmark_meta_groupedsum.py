...
import numpy as np
import pandas as pd
from tabularepimdl.arrayops import grouped_sum as grouped_sum_array
from tabularepimdl.matrixops import matrix_grouped_sum
...
def run_benchmarks():
    ...
    results_file, _ = generate_results_file("array_vs_matrix_grouped_sum")
