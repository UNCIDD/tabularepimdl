...
class SimpleObservationProcess_Vec_Encode(Rule, BaseModel):
    ...
    _check_domain_membership = domain_membership_validator(
        attribute_fields=("source_state", "unobs_state", "incobs_state", "prevobs_state"), domain_fields=("source_col_all_categories", "obs_col_all_categories", "infstate_compartments")
    )
    ...
    def to_dict(self) -> dict:
        ...
        """
        rc = {"tabularepimdl.SimpleObservationProcess_Vec_Encode": self.model_dump()}
        return rc
