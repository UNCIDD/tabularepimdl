...
class StateBasedDeathProcess_Vec_Encode(Rule, BaseModel):
    ...
    _check_domain_membership = domain_membership_validator(attribute_fields=("target_states",), domain_fields=("column_states",))
    ...
    def to_dict(self) -> dict:
        ...
        """
        rc = {"tabularepimdl.StateBasedDeathProcess_Vec_Encode": self.model_dump()}
        return rc
